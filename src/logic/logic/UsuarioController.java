...
public class UsuarioController extends IController {
	...
	public boolean AltaProponente(String nickname, String nombre, String apellido, String correoElec, LocalDate fechaNac, byte[] imagen, String direccion, String biografia, String linkWeb) {
        DTProponente DTprop = new DTProponente(nickname, nombre, apellido, correoElec, fechaNac, imagen, direccion, biografia, linkWeb);
    ...
    public boolean AltaColaborador(String nickname, String nombre, String apellido, String correoElec, LocalDate fechaNac, byte[] imagen) {
         DTColaborador DTcol = new DTColaborador(nickname, nombre, apellido, correoElec, fechaNac, imagen);
