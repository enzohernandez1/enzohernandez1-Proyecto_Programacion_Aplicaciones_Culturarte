...
public abstract class IController {
	 ...
	 */
	 public abstract boolean AltaProponente(String nickname, String pwd, String nombre, String apellido, String correoElec, LocalDate fechaNac, byte[] imagen, String direccion, String biografia, String linkWeb);
	    public abstract boolean AltaColaborador(String nickname, String pwd, String nombre, String apellido, String correoElec, LocalDate fechaNac, byte[] imagen);
  ...
  ArrayList<String> listarPropuestasEstado(Estado estado);*/
	...
	// Método para evaluar propuesta (cambiar estado y fecha)
		public abstract boolean evaluarPropuesta(String titulo, EstadoENUM nuevoEstado, String fechaCambio);
}
